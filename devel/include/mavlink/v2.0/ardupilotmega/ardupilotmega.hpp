...
enum class MAV_CMD
{
    ...
    DO_SPRAYER=216, /* Control attached liquid sprayer |0: disable sprayer. 1: enable sprayer.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
...
//! MAV_CMD ENUM_END
constexpr auto MAV_CMD_ENUM_END = 60021;
...
constexpr auto SCRIPTING_CMD_ENUM_END = 2;
