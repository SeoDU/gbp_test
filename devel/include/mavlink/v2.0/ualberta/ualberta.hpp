...
enum class UALBERTA_AUTOPILOT_MODE
{
...
//! UALBERTA_AUTOPILOT_MODE ENUM_END
constexpr auto UALBERTA_AUTOPILOT_MODE_ENUM_END = 6;

/** @brief Navigation filter mode */
enum class UALBERTA_NAV_MODE
{
    NAV_AHRS_INIT=1, /*  | */
...
//! UALBERTA_NAV_MODE ENUM_END
constexpr auto UALBERTA_NAV_MODE_ENUM_END = 5;

/** @brief Mode currently commanded by pilot */
enum class UALBERTA_PILOT_MODE
{
    PILOT_MANUAL=1, /*  sdf | */
    PILOT_AUTO=2, /*  dfs | */
...
//! UALBERTA_PILOT_MODE ENUM_END
constexpr auto UALBERTA_PILOT_MODE_ENUM_END = 4;
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_nav_filter_bias.hpp"
#include "./mavlink_msg_radio_calibration.hpp"
#include "./mavlink_msg_ualberta_sys_status.hpp"
