...
if("TRUE" STREQUAL "TRUE")
  set(rotors_comm_SOURCE_PREFIX /home/donguk/ros_workspace/gbplanner_ws/src/rotors_simulator/rotors_comm)
  set(rotors_comm_DEVEL_PREFIX /home/donguk/ros_workspace/gbplanner_ws/devel/.private/rotors_comm)
  ...
  set(rotors_comm_INSTALL_PREFIX /home/donguk/ros_workspace/gbplanner_ws/install)
...
if(NOT "/home/donguk/ros_workspace/gbplanner_ws/devel/.private/rotors_comm/include " STREQUAL " ")
  set(rotors_comm_INCLUDE_DIRS "")
  set(_include_dirs "/home/donguk/ros_workspace/gbplanner_ws/devel/.private/rotors_comm/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_comm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donguk/ros_workspace/gbplanner_ws/src/rotors_simulator/rotors_comm/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rotors_comm_NUM_DUMMY_TARGETS)
      set(rotors_comm_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rotors_comm::wrapped-linker-option${rotors_comm_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rotors_comm_NUM_DUMMY_TARGETS "${rotors_comm_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rotors_comm::wrapped-linker-option${rotors_comm_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rotors_comm_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/donguk/ros_workspace/gbplanner_ws/devel/.private/rotors_comm/lib;/home/donguk/ros_workspace/gbplanner_ws/devel/lib;/home/donguk/ros_workspace/catkin_ws/devel/lib;/opt/ros/melodic/lib)
