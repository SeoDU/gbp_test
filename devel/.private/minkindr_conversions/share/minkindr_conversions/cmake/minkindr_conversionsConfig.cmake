...
if("TRUE" STREQUAL "TRUE")
  set(minkindr_conversions_SOURCE_PREFIX /home/donguk/ros_workspace/gbplanner_ws/src/minkindr_ros/minkindr_conversions)
  set(minkindr_conversions_DEVEL_PREFIX /home/donguk/ros_workspace/gbplanner_ws/devel/.private/minkindr_conversions)
  ...
  set(minkindr_conversions_INSTALL_PREFIX /home/donguk/ros_workspace/gbplanner_ws/install)
...
if(NOT "/home/donguk/ros_workspace/gbplanner_ws/src/minkindr_ros/minkindr_conversions/include " STREQUAL " ")
  set(minkindr_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/donguk/ros_workspace/gbplanner_ws/src/minkindr_ros/minkindr_conversions/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'minkindr_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donguk/ros_workspace/gbplanner_ws/src/minkindr_ros/minkindr_conversions/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT minkindr_conversions_NUM_DUMMY_TARGETS)
      set(minkindr_conversions_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::minkindr_conversions::wrapped-linker-option${minkindr_conversions_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR minkindr_conversions_NUM_DUMMY_TARGETS "${minkindr_conversions_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::minkindr_conversions::wrapped-linker-option${minkindr_conversions_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND minkindr_conversions_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/donguk/ros_workspace/gbplanner_ws/devel/.private/minkindr_conversions/lib;/home/donguk/ros_workspace/gbplanner_ws/devel/lib;/home/donguk/ros_workspace/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
set(depends "eigen_conversions;geometry_msgs;gflags_catkin;glog_catkin;minkindr;tf;tf_conversions")
