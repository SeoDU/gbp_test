...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetBoxOccupancy-request>)))
  ...
  (cl:format cl:nil "# Message to make it easy to clear or set the occupancy of a bounding box.~%geometry_msgs/Vector3 box_center~%geometry_msgs/Vector3 box_size~%bool set_occupied  # Whether to set box free (false) or set occupied (true).~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetBoxOccupancy-request)))
  "Returns full string definition for message of type 'SetBoxOccupancy-request"
  (cl:format cl:nil "# Message to make it easy to clear or set the occupancy of a bounding box.~%geometry_msgs/Vector3 box_center~%geometry_msgs/Vector3 box_size~%bool set_occupied  # Whether to set box free (false) or set occupied (true).~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
