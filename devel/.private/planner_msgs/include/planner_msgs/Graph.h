...
struct Graph_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::planner_msgs::Vertex_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::planner_msgs::Vertex_<ContainerAllocator> >::other >  _vertices_type;
  _vertices_type vertices;

   typedef std::vector< ::planner_msgs::Edge_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::planner_msgs::Edge_<ContainerAllocator> >::other >  _edges_type;
  _edges_type edges;
