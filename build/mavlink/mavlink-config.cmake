...
set(mavlink_DIALECTS ASLUAV;all;ardupilotmega;common;development;icarous;matrixpilot;paparazzi;standard;uAvionix;ualberta)
set(mavlink2_DIALECTS ASLUAV;all;ardupilotmega;common;development;icarous;matrixpilot;paparazzi;standard;uAvionix;ualberta)

foreach(lib )
  set(onelib "${lib}-NOTFOUND")
  find_library(onelib ${lib}
      PATHS "/home/donguk/ros_workspace/gbplanner_ws/devel/lib"
    NO_DEFAULT_PATH
    )
  if(NOT onelib)
