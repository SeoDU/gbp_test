...
{
    GENERAL=0, /* General information which also includes information on other optional supported COMP_METADATA_TYPE's. Must be supported. Only downloadable from vehicle. | */
    PARAMETER=1, /* Parameter meta data. | */
    COMMANDS=2, /* Meta data which specifies the commands the vehicle supports. (WIP) | */
    PERIPHERALS=3, /* Meta data which specifies potential external peripherals that do not talk MAVLink | */
    EVENTS=4, /* Meta data for events interface | */
};
